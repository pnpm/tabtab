 ...
 * @property {Boolean} complete   A Boolean indicating whether we act in "plumbing mode" or not
 * @property {Number} words       The Number of words in the completed line
 * @property {Number} point       A Number indicating cursor position
 * @property {String} line        The String input line
 * @property {String} partial     The String part of line preceding cursor position
 * @property {String} last        The last String word of the line
 * @property {String} lastPartial The last word String of partial
 * @property {String} prev        The String word preceding last
 */
